...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  // of the cloud-workers subsystem that worker.desktop.observe depends on. Appends here
  // (not next to worker.desktop.launch above) so every older advertised index stays stable.
