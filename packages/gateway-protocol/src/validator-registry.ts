...
export const validateLocalDesktopObserveParams = compile(S.LocalDesktopObserveParamsSchema);
export const validateLocalDesktopObserveResult = compile(S.LocalDesktopObserveResultSchema);
